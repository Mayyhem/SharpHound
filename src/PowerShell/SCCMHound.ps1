...
Author: SpecterOps
Purpose:
  - Collect local sessions, user rights, and group members
  - Stage output for SharpHound collection via SCCM
...
# Only collect for CanRDP edge pending BloodHound support for other URAs
...
$output | ConvertTo-Json -Depth 6 -Compress | Out-File C:\Windows\CCM\ScriptStore\SCCMHound.log